/**
 * teensy_code_v4.ino - entry point for the Suuret Muinaiset V4 firmware.
 *
 * V4 is a working copy of V3, created to hunt a latent-undefined-behaviour
 * crash exposed by the GCC 5.4 -> 11.3 toolchain jump (Teensyduino 1.58+).
 * Behaviour is identical to V3; changes here are diagnostic until the fault
 * is found and fixed.
 *
 * ---------------------------------------------------------------------------
 * INSTALLATION
